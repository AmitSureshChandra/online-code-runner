...
@Service
@Slf4j
public class Cplus2Langservice extends CommonLangService{
    ...
    public Cplus2Langservice(DockerService dockerService, FileService fileService, ShellService shellService, FileUtil fileUtil) {
    ...
    public String setUpFiles(CodeReqDto dto) {
        ...
        String filePath = System.getProperty("user.dir") + "/" + userFolder + "/main.c";
